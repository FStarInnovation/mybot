...
declare module '$env/static/private' {
	...
	export const VITE_PWA_ENABLED: string;
	export const VITE_PWA_REGISTER_TYPE: string;
	export const VITE_FEATURE_OFFLINE: string;
	export const VITE_FEATURE_NOTIFICATIONS: string;
